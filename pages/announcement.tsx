...
import { PlasmicAnnouncement } from "../components/plasmic/shinkan_next/PlasmicAnnouncement";
...
function Announcement() {
  ...
  //
  // By default, PlasmicAnnouncement is wrapped by your project's global
  // variant context providers. These wrappers may be moved to
  // Next.js Custom App component
  // (https://nextjs.org/docs/advanced-features/custom-app).
  return <PlasmicAnnouncement />;
}
