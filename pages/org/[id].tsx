...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  return { props: { variableConsumer: params } };
};
function Orgid() {
  // Use PlasmicOrgid to render this component as it was
  // designed in Plasmic, by activating the appropriate variants,
  // attaching the appropriate event handlers, etc.  You
  // can also install whatever React hooks you need here to manage state or
  // fetch data.
  //
  // Props you can pass into PlasmicOrgid are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, PlasmicOrgid is wrapped by your project's global
  ...
  if (router.isFallback) {
    // build time the data is not exist
  }
  ...
  const [orgData, setOrgData] = useState({
    ...
    descriptionHtml: "<b>やりますねぇ！</b>",
  });

  return (
    <PlasmicOrgid
      image={<img src={orgData.images[0]} />}
      events={orgData.events.map((e) => (
