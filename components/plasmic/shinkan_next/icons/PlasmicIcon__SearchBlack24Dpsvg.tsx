...
export type SearchBlack24DpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function SearchBlack24DpsvgIcon(props: SearchBlack24DpsvgIconProps) {
...
export default SearchBlack24DpsvgIcon;
/* prettier-ignore-end */
