...
export type FormatListBulletedBlack24DpsvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function FormatListBulletedBlack24DpsvgIcon(
  props: FormatListBulletedBlack24DpsvgIconProps
) {
...
export default FormatListBulletedBlack24DpsvgIcon;
/* prettier-ignore-end */
