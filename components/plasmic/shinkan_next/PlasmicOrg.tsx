...
export const PlasmicOrg__ArgProps = new Array<ArgPropType>("orgs");
...
const PlasmicDescendants = {
  root: ["root", "page", "searchBox", "searchInput", "svg", "orgList"],
  page: ["page", "searchBox", "searchInput", "svg", "orgList"],
